...
# Determines whether the given body that is currently colliding with the drum
# set can interact with it.
func can_interact(body: Node):
	return body is Character and body.type == Character.Type.DRUMMER
